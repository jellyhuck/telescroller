...
var $author$project$Main$init = function (storedStateJson) {
	return _Utils_Tuple2(
		A2(
			$author$project$Main$decodePersistentModel,
			$author$project$Main$initialModel,
			A2($elm$core$Maybe$withDefault, '', storedStateJson)),
...
var $author$project$Main$storePersistentModel = _Platform_outgoingPort('storePersistentModel', $elm$json$Json$Encode$string);
var $author$project$Main$encodePersistentModel = F2(
	function (includingText, model) {
		return $author$project$Main$storePersistentModel(
			A2(
					...
					function () {
						...
						if (!_v1) {
							...
							return _Utils_update(
								model,
								{
									t: A2($author$project$Main$calculateOffset, model, d)
								});
						}
					}(),
					$elm$core$Platform$Cmd$none);
...
var $author$project$Main$ChangeEditMode = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$renderNavs = function (model) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('nav nav-pills p-1 ml-1')
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$ChangeEditMode(1)),
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('nav-link'),
								$elm$html$Html$Events$onClick(
								$author$project$Main$ChangeEditMode(0)),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
				...
				_List_fromArray(
					[
						...
						'btn mx-1 ' + A2($author$project$Main$buttonClass, 'primary', model.p === 1)),
						$elm$html$Html$Events$onClick(
						$author$project$Main$ChangePauseMode(1))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class(
						'btn mx-1 ' + A2($author$project$Main$buttonClass, 'secondary', !model.p)),
						$elm$html$Html$Events$onClick(
						$author$project$Main$ChangePauseMode(0))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn mx-5 btn-sm'),
						$elm$html$Html$Events$onClick($author$project$Main$ResetTele)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$renderNavs(model),
				$author$project$Main$renderTextContent(model)
			]));
};
